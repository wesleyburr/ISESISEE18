...
**Put an air pollution map in here: make one?**
...
* Focused on Toronto area for 2012
...
we can iterate the algorithm convergence and obtain a contiguous series by using remotely sensed data as a **baseline** for the interpolator.
...
(show some component data: EC, etc.)
...
has given us a contiguous **ground-level** particulate matter component series. 
...
* Possibly not!
* Creative use of tempora-spatial statistics and field estimation may bypass need
